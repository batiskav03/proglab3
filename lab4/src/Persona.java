...
public abstract class Persona implements Comparable {
    ...
    public Persona(String name, int friendliness) throws FriendlessExeption {
        this.name = name;
    ...
    public void setFriendliness(int friendliness) throws FriendlessExeption {
        if ((friendliness <= 0) || (friendliness >= 10)) {
            throw new FriendlessExeption("wrong friendless");
        }else {
