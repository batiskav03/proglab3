public class Bunny extends DefaultPersona{
    ...
    public Bunny(String name, int friendless) throws FriendlessExeption {
    ...
    public void talkwithgroupaboutplan() {
        System.out.println("Кролик начинает объяснять, почему севодня самый подходяший пдень для воплощения их плана в жизнь");
    }
    public void Whistle(){
